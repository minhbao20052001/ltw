...
<div class="main">
    <form method="POST" class="form" id="form-1" action="login/register">
      ...
      <div class="form-group">
        ...
        <input id="fullname" name="member_name" type="text" placeholder="Ex: Nguyen Van A" class="form-control">
        <span class="form-message"></span>
      </div>

      <div class="form-group">
        <label for="phonenumber" class="form-label">Phone number</label>
        <input id="phonenumber" name="member_phone" type="number" placeholder="Ex: 0969696969" class="form-control">
        <span class="form-message"></span>
      </div>
      
      <div class="form-group">
        <label for="email" class="form-label">Email</label>
        <input id="email" name="member_email" type="email" placeholder="Ex: email@domain.com" class="form-control">
        <span class="form-message"></span>
      </div>

      <div class="form-group">
        <label for="password" class="form-label">Password</label>
        <input id="password" name="member_password" type="password" placeholder="Enter password" class="form-control">
        <span class="form-message"></span>
      </div>
